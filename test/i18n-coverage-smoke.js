...
const dynamic = /^(?:Could not |Browse all work for |Open |Remove filter |Remove tag |Moved to |Session logged to |History — |Role: |Credential location: |Type "|Tasks \(|Client Tasks \(|Internal Tasks \(|Sessions \(|Documents \(|PDF failed: |Full backup failed: |Full restore stopped: |Updated |Overdue — |Renews |Expires |in “)/;
