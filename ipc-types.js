 ...
 * @property {number|null} supportYearId Linked project_support_years id (migration 035), or null when unlinked. Mutually exclusive with projectId/departmentId — a task carries at most one of the three.
