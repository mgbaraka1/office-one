// ─────────────────────────────────────────────────────────────────────────────
// Finance — standalone financial record-keeping data layer for Finance
...
// Files live at <userData>/finance_it/{entityType}/{entityId}/{timestamp}.{ext}.
...
function finAttachmentEntityDir(entityType, entityId) {
  return path.join('finance_it', entityType, String(entityId));
}
...
// outside finance_it/{entityType}/{entityId}/, including the live DB file.
