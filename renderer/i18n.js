...
(function () {
  ...
  const ar = {
    ...
    'Add Internal Task': 'إضافة مهمة داخلية', 'Edit Internal Task': 'تعديل مهمة داخلية',
    'Internal Task Details': 'تفاصيل المهمة الداخلية', 'Internal task created': 'تم إنشاء المهمة الداخلية',
    'Internal task updated': 'تم تحديث المهمة الداخلية', 'Could not save the internal task': 'تعذّر حفظ المهمة الداخلية',
    'Convert Task': 'تحويل المهمة', 'Convert': 'تحويل',
    'Convert to Internal Task': 'تحويل إلى مهمة داخلية', 'Convert to Client Task': 'تحويل إلى مهمة عميل',
    'Convert to internal task': 'تحويل إلى مهمة داخلية', 'Convert to client task': 'تحويل إلى مهمة عميل',
    'Converted to internal task': 'تم التحويل إلى مهمة داخلية', 'Converted to client task': 'تم التحويل إلى مهمة عميل',
    'Could not convert task': 'تعذّر تحويل المهمة',
    'Create client task': 'إنشاء مهمة عميل', 'Create internal task': 'إنشاء مهمة داخلية',
    'Plan work for a client, optionally linked to a project': 'خطط لعمل عميل، مع إمكانية ربطه بمشروع',
    'Plan work for your own organisation, by department': 'خطط لعمل مؤسستك الخاصة، حسب القسم',
    'No internal tasks yet — use “New Task” to add one.': 'لا توجد مهام داخلية بعد — استخدم «مهمة جديدة» لإضافة واحدة.',
    'No internal tasks match these filters.': 'لا توجد مهام داخلية مطابقة لعوامل التصفية هذه.',
    'Search internal tasks…': 'البحث في المهام الداخلية…',
    'Organisation name': 'اسم المؤسسة', 'e.g. your company\'s own name': 'مثال: اسم مؤسستك',
    'Printed on Daily/Monthly report headers for internal (department) work and as the Internal Work page\'s subtitle — never a Company, so it can never appear on the Clients page or in a project\'s client list. Leave blank to print "Internal" instead.':
      'تُطبع في ترويسات تقارير العمل اليومي/الشهري للعمل الداخلي (القسم) وكعنوان فرعي لصفحة العمل الداخلي — وليست أبدًا شركة عميل، فلا يمكن أن تظهر في صفحة العملاء أو في قائمة عملاء أي مشروع. اتركه فارغًا لطباعة "داخلي" بدلاً من ذلك.',
    'Show client work, internal work, or both': 'إظهار عمل العملاء أو العمل الداخلي أو كليهما',
    ...
    'No records in that period — showing an empty report': 'لا توجد سجلات في تلك الفترة — سيُعرض تقرير فارغ',
    'No work recorded in this period.': 'لا يوجد عمل مسجل في هذه الفترة.',
  ...
  Object.assign(ar, {
    ...
    // Finance Create Hub flows and their client picker (plan §5).
    'Pick a client': 'اختر عميلاً',
    'New Contract — pick a client': 'عقد جديد — اختر عميلاً',
    'New Invoice — pick a client': 'فاتورة جديدة — اختر عميلاً',
    'Create contract': 'إنشاء عقد',
    'Record a client contract, its versions and installments': 'سجّل عقد عميل وإصداراته ودفعاته',
    'Raise invoice': 'إصدار فاتورة',
    'Invoice a client and allocate it against contract work': 'أصدر فاتورة لعميل ووزّعها على أعمال العقد',
    ...
    'Create a new internal task already linked to this department': 'إنشاء مهمة داخلية جديدة مرتبطة بهذا القسم',
