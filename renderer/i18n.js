...
(function () {
  ...
  const ar = {
    ...
    'New Project': 'مشروع جديد', 'Project deleted': 'تم حذف المشروع',
    ...
    'Create Item': 'إنشاء عنصر', 'Write an article': 'كتابة مقال',
    ...
    'Quick actions': 'إجراءات سريعة', 'Recently updated': 'تم تحديثها مؤخراً',
    ...
    'Add new (context-dependent: Timesheet record, task, project, subscription, document, or knowledge item)': 'إضافة جديد (حسب السياق: سجل دوام أو مهمة أو مشروع أو اشتراك أو مستند أو عنصر معرفة)',
  ...
  Object.assign(ar, {
    ...
    'Workspace view & comfort': 'عرض مساحة العمل والراحة',
